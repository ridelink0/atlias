...
Cohesion: 0.13
Nodes (41): appendLine(), detach(), ensureDir(), events(), log(), mtime(), projectDir(), readJsonl() (+33 more)

### Community 1 - "hosts.mjs"
Cohesion: 0.08
Nodes (67): BRIEF_BUDGET_MS, build(), companions(), fitLines(), RULES, CLAUDE_DIR, claudeMemoryDir(), exists() (+59 more)
...
Cohesion: 0.14
Nodes (27): findPython(), gitStatusShort(), graphify(), run(), TURN_TAIL, block(), changedFiles(), lastPrompt() (+19 more)

### Community 5 - "core.mjs"
Cohesion: 0.07
Nodes (51): sessionStart(), CODE_EXT, CODEX_DIR, commandFromTool(), detectHost(), emit(), END_MARK, EVENT_MAX (+43 more)
...
Cohesion: 0.07
Nodes (28): 1.0.0 (2026-09-21), 1.2.0 (2026-09-22), 1.3.0 (2026-09-22), 1.4.0 (2026-09-22), 1.4.1 (2026-09-22), 1.5.0 (2026-09-22), 1.5.1 (2026-09-22), 1.6.0 (2026-09-22) (+20 more)

### Community 16 - "atlias.mjs"
Cohesion: 0.12
Nodes (13): argv, cwd, FLAG_COMMANDS, DEFAULTS, parseSetting(), STATE_DIR, VERSION, fail() (+5 more)

## Knowledge Gaps
- **123 isolated node(s):** `$schema`, `name`, `description`, `name`, `email` (+118 more)
