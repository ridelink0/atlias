...
Cohesion: 0.22
Nodes (15): claudeMemoryDir(), slug(), VERSION, syntaxReport(), doctor(), formatDoctor(), fail(), handle() (+7 more)

### Community 1 - "hosts.mjs"
Cohesion: 0.10
Nodes (46): CODEX_DIR, END_MARK, GEMINI_DIR, readJson(), readText(), run(), START_MARK, writeJson() (+38 more)
...
Cohesion: 0.12
Nodes (30): CODE_EXT, commandFromTool(), detectHost(), emit(), EVENT_MAX, eventsTail(), filesFromTool(), GUARD_TAIL (+22 more)
...
Cohesion: 0.38
Nodes (10): TURN_TAIL, applyNext(), build(), nextPath(), notePath(), postCompact(), preCompact(), read() (+2 more)

### Community 8 - "dream.mjs"
Cohesion: 0.17
Nodes (31): appendLine(), detach(), ensureDir(), events(), log(), projectDir(), readJsonl(), readLines() (+23 more)
...
### Community 11 - "graph.mjs"
Cohesion: 0.10
Nodes (43): BRIEF_BUDGET_MS, build(), companions(), RULES, sessionStart(), CLAUDE_DIR, exists(), findPython() (+35 more)
...
Cohesion: 0.11
Nodes (18): 1.0.0 (2026-09-21), 1.2.0 (2026-09-22), 1.3.0 (2026-09-22), 1.4.0 (2026-09-22), 1.4.1 (2026-09-22), 1.5.0 (2026-09-22), 1.5.1 (2026-09-22), 1.6.0 (2026-09-22) (+10 more)

### Community 16 - "atlias.mjs"
Cohesion: 0.14
Nodes (13): argv, cwd, briefCost(), estimateTokens(), graphVsFiles(), interventions(), liveSessions(), report() (+5 more)

## Knowledge Gaps
- **105 isolated node(s):** `$schema`, `name`, `description`, `name`, `email` (+100 more)
