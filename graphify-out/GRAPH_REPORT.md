...
Cohesion: 0.21
Nodes (16): claudeMemoryDir(), slug(), VERSION, syntaxReport(), doctor(), doctorRows(), formatDoctor(), fail() (+8 more)

### Community 1 - "hosts.mjs"
Cohesion: 0.12
Nodes (41): HOME, readJson(), readText(), START_MARK, writeJson(), writeText(), CODEX_EVENTS, dropAtliasTables() (+33 more)
...
Cohesion: 0.14
Nodes (26): sessionStart(), findPython(), graphify(), isCodeFile(), run(), saveSessionMeta(), sessionMeta(), sessionMetaPath() (+18 more)

### Community 5 - "core.mjs"
Cohesion: 0.10
Nodes (43): build(), companions(), clip(), CODE_EXT, CODEX_DIR, commandFromTool(), detectHost(), emit() (+35 more)
...
Cohesion: 0.13
Nodes (38): appendLine(), detach(), ensureDir(), events(), log(), mtime(), projectDir(), readJsonl() (+30 more)
...
## Knowledge Gaps
- **95 isolated node(s):** `$schema`, `name`, `description`, `name`, `email` (+90 more)
...
- **Why does `uninstall()` connect `hosts.mjs` to `atlias`, `core.mjs`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
