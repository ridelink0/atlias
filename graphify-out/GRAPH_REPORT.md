...
Cohesion: 0.10
Nodes (22): argv, cwd, claudeMemoryDir(), DEFAULTS, ROOT, slug(), STATE_DIR, VERSION (+14 more)

### Community 1 - "hosts.mjs"
Cohesion: 0.12
Nodes (42): readJson(), readText(), START_MARK, writeJson(), writeText(), CODEX_EVENTS, doctor(), dropAtliasTables() (+34 more)
...
Cohesion: 0.11
Nodes (42): BRIEF_BUDGET_MS, build(), companions(), RULES, sessionStart(), exists(), findPython(), graphify() (+34 more)

### Community 5 - "core.mjs"
Cohesion: 0.12
Nodes (31): CLAUDE_DIR, clip(), CODE_EXT, CODEX_DIR, commandFromTool(), detectHost(), emit(), END_MARK (+23 more)
...
Cohesion: 0.20
Nodes (17): briefCost(), estimateTokens(), graphVsFiles(), interventions(), liveSessions(), report(), eventsTail(), readTail() (+9 more)
...
Cohesion: 0.12
Nodes (15): 1.0.0 (2026-09-21), 1.2.0 (2026-09-22), 1.3.0 (2026-09-22), 1.4.0 (2026-09-22), 1.4.1 (2026-09-22), 1.5.0 (2026-09-22), 1.5.1 (2026-09-22), 1.6.0 (2026-09-22) (+7 more)

## Knowledge Gaps
- **101 isolated node(s):** `$schema`, `name`, `description`, `name`, `email` (+96 more)
